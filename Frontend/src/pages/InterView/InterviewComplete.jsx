        ...
        >
          ...
          >
            ...
            <p className="mt-2 text-white/45 text-sm md:text-[15px] leading-7">
              ...
              position has been successfully recorded. Our hiring team will
              review your responses and get back to you within a few business
              days.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="text-center">
              <h3 className="text-4xl font-black text-white">0m 59s</h3>
              <p className="mt-1 text-xs tracking-wide text-white/30 uppercase">
                Duration
              </p>
            </div>
            ...
            <div className="space-y-5">
              {steps.map((item, i) => (
                ...
                >
                  ...
                  <p className="text-sm text-white/60 leading-6">{item}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
