...
const CodeEditorPrac = ({ currentQuestion, currentIndex, code, output, onCodeChange, onOutputChange }) => {
  ...
  return (
    <main className="h-full min-h-0 flex flex-col overflow-hidden"
      ...
      <div className="h-14 shrink-0 px-5 flex items-center justify-between gap-4"
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="px-4 py-1.5 rounded-lg text-[12px] font-bold transition-all disabled:opacity-40 flex items-center gap-1.5"
            style={{
      ...
      {/* Editor + Output */}
      <div className="flex-1 min-h-0 overflow-hidden grid grid-rows-[minmax(0,1fr)_260px]">
