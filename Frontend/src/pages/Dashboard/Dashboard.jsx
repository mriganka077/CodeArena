...
const Dashboard = () => {
  ...
  const cardConfig = {
    drive: { orb1: 'bg-emerald-400', orb2: 'bg-teal-400', iconBox: 'from-emerald-400 to-teal-400 shadow-[0_10px_30px_rgba(16,185,129,0.4)]', iconGlow: 'rgba(16,185,129,0.4)', badge: 'bg-emerald-500/15 border-emerald-500/30 text-emerald-400', statIcon: 'bg-emerald-500/15 text-emerald-400', btn: 'from-emerald-400 to-teal-400 shadow-[0_8px_25px_rgba(16,185,129,0.35)] hover:shadow-[0_12px_35px_rgba(16,185,129,0.5)]',
    ...
    practice: { orb1: 'bg-purple-500', orb2: 'bg-indigo-500', iconBox: 'from-indigo-500 to-purple-600 shadow-[0_10px_30px_rgba(99,102,241,0.4)]', iconGlow: 'rgba(99,102,241,0.4)', badge: 'bg-purple-500/20 border-purple-500/40 text-purple-400', statIcon: 'bg-purple-500/15 text-purple-400', btn: 'from-indigo-500 to-purple-600 shadow-[0_8px_25px_rgba(99,102,241,0.35)] hover:shadow-[0_12px_35px_rgba(99,102,241,0.5)]',
      icon: (<><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /></>) },
    mock: { orb1: 'bg-orange-500', orb2: 'bg-red-400', iconBox: 'from-orange-500 to-red-400 shadow-[0_10px_30px_rgba(249,115,22,0.4)]', iconGlow: 'rgba(249,115,22,0.4)', badge: 'bg-orange-500/20 border-orange-500/40 text-orange-400', statIcon: 'bg-orange-500/15 text-orange-400', btn: 'from-orange-500 to-red-400 shadow-[0_8px_25px_rgba(249,115,22,0.35)] hover:shadow-[0_12px_35px_rgba(249,115,22,0.5)]',
    ...
    <>
      ...
      <div className="min-h-screen relative">
        ...
        <style>{`
          ...
          .ring-1{width:240px;height:240px;top:-120px;left:-120px;animation:ring-pulse 3s ease-in-out infinite}
          .ring-2{width:280px;height:280px;top:-140px;left:-140px;animation:ring-pulse 3s ease-in-out infinite 1.5s}
          ...
          .bg-shimmer { animation: shimmer-line 8s linear infinite; }
          .bg-rotate { animation: gradient-rotate 40s linear infinite; }
        ...
        >
          ...
          {/* Blob 5 — Emerald accent — Bottom Right */}
          <div
            className="bg-blob-1 absolute rounded-full"
            style={{
              bottom: "10%",
        ...
        <div
          className="relative px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 2xl:px-28
                        py-6 sm:py-8 max-w-[1600px] mx-auto"
          style={{ zIndex: 10 }}
        >
          {/* ═══════ Header Section ═══════ */}
          ...
          <ScrollReveal direction="left" delay={100}>
            <div className="flex items-center gap-4 sm:gap-5 mb-8">
              <div className="w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 bg-indigo-500/15 border border-indigo-500/25 backdrop-blur-sm">
                <svg
              ...
              <div className="flex-1 h-0.5 rounded-full bg-gradient-to-r from-indigo-500/40 to-transparent" />
            </div>
          </ScrollReveal>

          {/* ═══════ Stats Grid ═══════ */}
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8 mb-14">
            {/* ──── Box 1: Pie Chart ──── */}
          ...
          <ScrollReveal direction="left" delay={100}>
            <div className="flex items-center gap-4 sm:gap-5 mb-8">
              <div className="w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 bg-fuchsia-500/15 border border-fuchsia-500/25 backdrop-blur-sm">
                <svg
              ...
              <div className="flex-1 h-0.5 rounded-full bg-gradient-to-r from-fuchsia-500/40 to-transparent" />
            </div>
          </ScrollReveal>

          {/* ═══════ Category Cards ═══════ */}
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8 pb-12">
